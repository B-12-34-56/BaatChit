...
// Debug: Print loaded environment variables (without exposing secrets)
...
const AWS_SESSION_TOKEN = 'sessionToken'; // Optional, for temporary creds
const S3_SUBFOLDER = 'image-test/';
